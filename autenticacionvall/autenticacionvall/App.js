...
export default function App() {
  ...
  return (
    <View style={{ padding: 20, marginTop: 50 }}>
      ...
      <Button
        ...
        onPress={async () => {
          ...
          try {
            ...
            showMessage({
              text: "El codigo de verificacion ha sido enviado a tu numero de telefono.",
            });
          } catch (err) {
      ...
      />
      <Button
        title="Confirmar codigo de verificacion"
        ...
        onPress={async () => {
          try {
            ...
            showMessage({ text: "Autenticacion exitosa 👍" });
          } catch (err) {
            showMessage({ text: `Error: ${err.message}`, color: "red" });
          }
        }}
